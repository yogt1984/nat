...
latent state observed twice. Formal independence tests beyond
IC-level orthogonality (distance correlation / HSIC) are
pre-registered for the replication month
...
not been reported at this granularity. A third time-point is
pre-registered for the replication month
(Section~\ref{sec:replication}).
...
is less contested. The fill-conditional version of the entropy gate
--- the decisive test of whether regime conditioning survives at
execution --- is pre-registered for the replication month
(Section~\ref{sec:replication}).
