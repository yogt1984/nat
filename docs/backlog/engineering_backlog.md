...
`PortfolioConstraints` dataclass and `check_portfolio_constraints()` in deployer. Aggregate leverage cap, concentration (Herfindahl/effective-N), portfolio drawdown circuit breaker. 8 test cases, all passing.
