...
test_agent:
	...
	@echo "╚══════════════════════════════════════════════════════════════════╝"
	@echo ""
	cd scripts && $(PYTHON) -m pytest tests/test_agent_base.py tests/test_agent_cache.py tests/test_agent_dashboard.py tests/test_agent_monitor.py tests/test_agent_ensemble.py tests/test_mf_agent.py tests/test_macro_agent.py -v
